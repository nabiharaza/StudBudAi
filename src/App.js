...
const API_KEY = "AIzaSyDUra2zWYK8BsyewyCxCBpNeK4HfOYVzp4";
...
const App = () => {
        ...
        const [numFlashcards, setNumFlashcards] = useState(10); // State to hold the number of flashcards
        const [chat, setChat] = useState(null); // State to hold the chat object

        useEffect(() => {
            // Initialize GenAI object and chat object when the component mounts
...
Separate each flashcard with a blank line.`;
                ...
                const result = await chat.sendMessage(prompt); // Use chat object to send message
        ...
        return (
            <div className="app-container">
                ...
                <div className={`content-area${collapsed ? ' collapsed' : ''}`}>
                    ...
                    {/*{!selectedOption && !summary && <h1>Main Content</h1>}*/}
                </div>
